  ...
  return (
    <div className="aiss__wrapper">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        /* 1. MAKE CONTAINER WIDER AND CENTERED (Aligns with navbar logo) */
        html body .aiss__wrapper .sp-hero-split .aiwd-container,
        html body .aiss__wrapper .sp-hero-split [class*="container"],
        html body .aiss__wrapper .aiwa__container {
          max-width: 1400px !important;
          width: 100% !important;
          margin: 0 auto !important;        /* Centers the container on the screen */
          padding-left: 2.5rem !important;  /* Pushes left text to line up with logo */
          padding-right: 2.5rem !important;
        }

        /* ─── DESKTOP VIEWPORTS (1025px and Up) ─── */
        @media (min-width: 1025px) {
          /* Split columns: 35% text on left, 65% image on right */
          html body .aiss__wrapper [class*="sp-hero-split-grid"] {
          ...
          /* Image column wrapper layout */
          html body .aiss__wrapper .sp-hero-image-wrap {
          ...
          /* Next.js Inner Helper Wrappers (Kept fluid to prevent layout loop shaking) */
          html body .aiss__wrapper .sp-hero-image-wrap span,
          html body .aiss__wrapper .sp-hero-image-wrap div {
          ...
          /* Desktop image rendering size — ZOOMED & ENLARGED */
          html body .aiss__wrapper img.sp-hero-image,
          html body .aiss__wrapper img[src*="aisoftware"],
          html body .aiss__wrapper .sp-hero-image-wrap img {
            width: 100% !important;
            max-width: 950px !important;        /* Increased desktop max-width limit */
            min-width: 580px !important;        /* Prevents graphic from shrinking */
            height: auto !important;
            object-fit: contain !important;
            transition: none !important;
            aspect-ratio: 16 / 10 !important;   /* Reserves container bounds instantly on render to prevent CLS */
          ...
          /* Desktop alignment - align all left edges perfectly */
          html body .aiss__wrapper div.sp-hero-split-content div.breadcrumb-wrap div.breadcrumb-container,
          html body .aiss__wrapper div.sp-hero-split-content div[class*="breadcrumb"],
          html body .aiss__wrapper div.sp-hero-split-content div[class*="breadcrumb-wrap"] {
            margin-left: 110px !important;      /* Shifted breadcrumbs specifically to the right */
            padding-left: 0 !important;
            justify-content: flex-start !important;
          }

          /* FIXED: Prevent badge stretching by using display: inline-flex */
          html body .aiss__wrapper div.sp-hero-split-content div.sp-hero-badge,
          html body .aiss__wrapper div.sp-hero-split-content [class*="badge"],
          html body .aiss__wrapper [class*="sp-hero-split-badge"] {
            margin-left: 0 !important; 
            justify-content: flex-start !important;
            display: inline-flex !important;    /* Shrink wrap around label text */
            width: max-content !important;      /* Prevents full-width container stretches */
          }

          html body .aiss__wrapper div.sp-hero-split-content .sp-hero-split-features,
          html body .aiss__wrapper div.sp-hero-split-content [class*="sp-hero-split-features"] {
            display: flex !important;
        ...
        /* ─── MOBILE VIEWPORTS (1024px and Down) ─── */
        @media (max-width: 1024px) {
          ...
          html body .aiss__wrapper div.breadcrumb-wrap,
          html body .aiss__wrapper div[class*="breadcrumb-wrap"] {
            display: flex !important;
          ...
          html body .aiss__wrapper div[class*="breadcrumb"] * {
            font-size: 11px !important;
            white-space: nowrap !important;
          }

          html body .aiss__wrapper section.sp-hero-split div.sp-hero-badge {
            margin: 0 auto 16px auto !important;
            display: flex !important;
          }

          /* Stacked left-aligned checklist block centered on mobile screen */
          html body .aiss__wrapper .sp-hero-split-features,
          html body .aiss__wrapper [class*="sp-hero-split-features"] {
            display: flex !important;
            flex-direction: column !important;
          ...
          /* Upward shifted mobile image container */
          html body .aiss__wrapper .sp-hero-image-wrap {
