  ...
  return (
    <div className="fswd__wrapper">
      ...
      <style>{`
        ...
        html body div.fswd__wrapper .sp-hero-split .aiwd-container,
        html body div.fswd__wrapper .sp-hero-split [class*=container] {
          max-width: 1400px !important;
          width: 100% !important;
          margin: 0 auto !important;        /* Centers container on screen */
          padding-left: 2.5rem !important;  /* Perfect alignment with navbar logo */
          padding-right: 2.5rem !important;
        }

        /* ─── DESKTOP VIEWPORTS (1025px and Up) ─── */
        @media (min-width: 1025px) {
          /* Split columns: 45% text on left, 55% image on right (Same as other pages) */
          html body div.fswd__wrapper [class*=sp-hero-split-grid] {
          ...
          html body div.fswd__wrapper .sp-hero-image-wrap {
            display: flex !important;
            justify-content: flex-start !important; 
            margin-left: -50px !important; /* Pulls graphic closer to description */
            width: 100% !important;
          ...
          html body div.fswd__wrapper .sp-hero-image-wrap span,
          html body div.fswd__wrapper .sp-hero-image-wrap div {
          ...
          /* Desktop image rendering size */
          html body div.fswd__wrapper img.sp-hero-image,
          html body div.fswd__wrapper img[src*=fullstack],
          html body div.fswd__wrapper .sp-hero-image-wrap img {
            width: 100% !important;
          ...
          /* Desktop alignment - align all left edges perfectly to the logo margin */
          html body div.fswd__wrapper div.sp-hero-split-content div.breadcrumb-wrap div.breadcrumb-container,
          html body div.fswd__wrapper div.sp-hero-split-content div[class*=breadcrumb],
          html body div.fswd__wrapper div.sp-hero-split-content div[class*=breadcrumb-wrap],
          html body div.fswd__wrapper div.sp-hero-split-content div.breadcrumb-wrap,
          html body div.fswd__wrapper div.sp-hero-split-content div.breadcrumb-wrap * {
            margin-left: 0 !important; /* Aligned to the left axis */
            padding-left: 0 !important;
            font-size: 10px !important;
            justify-content: flex-start !important;
          }

          html body div.fswd__wrapper div.sp-hero-split-content div.sp-hero-badge,
          html body div.fswd__wrapper div.sp-hero-split-content [class*=badge],
          html body div.fswd__wrapper [class*=sp-hero-split-badge] {
            margin-left: 0 !important; /* Aligned to the left axis */
            justify-content: flex-start !important;
          ...
          html body div.fswd__wrapper div.sp-hero-split-content .sp-hero-split-features,
          html body div.fswd__wrapper div.sp-hero-split-content [class*=sp-hero-split-features] {
            display: flex !important;
